...
import edu.wccnet.cooconnor.springMVC.domain.Pet;
import edu.wccnet.cooconnor.springMVC.domain.PetRegService;
...
public class MainController {
	...
	public void populateFormWithData(Model model) {
		...
		model.addAttribute("sourceList", regService.populateSources());
	}
